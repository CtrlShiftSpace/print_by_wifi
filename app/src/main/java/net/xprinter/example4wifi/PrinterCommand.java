...
public class PrinterCommand {
    ...
    public static final byte ESC_FF = 0x04;

    public static final byte[] ESC_SELECT_BOLD = new byte[] { 0x1B, 0x45, 0 };

    public static final byte[] ABSOLUTION_POS_A = new byte[] { 0x1B, 0x24, 20 , 1};
    public static final byte[] ABSOLUTION_POS_B = new byte[] { 0x1B, 0x24, 99 , 1};
    public static final byte[] ABSOLUTION_POS_C = new byte[] { 0x1B, 0x24, 110 , 1};
